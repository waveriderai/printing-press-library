...
Exit codes & warnings:
  ...
  follow-up-boss-pp-cli sync

  # Sync specific resources only
  follow-up-boss-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  follow-up-boss-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  follow-up-boss-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  follow-up-boss-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  follow-up-boss-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/follow-up-boss-pp-cli/data.db)")
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		...
		"action-plans-people":    "/actionPlansPeople",
		"appointment-outcomes":   "/appointmentOutcomes",
		"appointment-types":      "/appointmentTypes",
		"appointments":           "/appointments",
		"automations":            "/automations",
		"automations-people":     "/automationsPeople",
		"calls":                  "/calls",
		"custom-fields":          "/customFields",
		"deal-custom-fields":     "/dealCustomFields",
		"deals":                  "/deals",
		"em-campaigns":           "/emCampaigns",
		"em-events":              "/emEvents",
		"events":                 "/events",
		"groups":                 "/groups",
		"groups-round-robin":     "/groups/roundRobin",
		"identity":               "/identity",
		"me":                     "/me",
		"people":                 "/people",
		"people-check-duplicate": "/people/checkDuplicate",
		"people-relationships":   "/peopleRelationships",
		"people-unclaimed":       "/people/unclaimed",
		"pipelines":              "/pipelines",
		"ponds":                  "/ponds",
		"smart-lists":            "/smartLists",
		"stages":                 "/stages",
		"tasks":                  "/tasks",
		"team-inboxes":           "/teamInboxes",
		"teams":                  "/teams",
		"templates":              "/templates",
		"text-message-templates": "/textMessageTemplates",
