...
native streaming instead of polling.`,
  ...
  follow-up-boss-pp-cli tail --interval 10s

  # Tail a specific resource
  follow-up-boss-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  follow-up-boss-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
