...
but do not stop the import.`,
  ...
  follow-up-boss-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  follow-up-boss-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | follow-up-boss-pp-cli import <resource> --input -`,
