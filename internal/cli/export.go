...
large datasets as it has no memory pressure.`,
  ...
  follow-up-boss-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  follow-up-boss-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  follow-up-boss-pp-cli export <resource> --format jsonl | jq '.id'`,
