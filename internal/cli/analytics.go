...
Data must be synced first with the sync command.`,
  ...
  follow-up-boss-pp-cli analytics --type messages

  # Group by a field
  follow-up-boss-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  follow-up-boss-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
