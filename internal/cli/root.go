...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "follow-up-boss-pp-cli",
		Short: "Manage follow-up-boss resources via the follow-up-boss API",
		Long: `Manage follow-up-boss resources via the follow-up-boss API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'follow-up-boss-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("follow-up-boss-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'follow-up-boss-pp-cli profile list')")
	...
	rootCmd.AddCommand(newActionPlansPeopleCmd(flags))
	rootCmd.AddCommand(newAppointmentOutcomesCmd(flags))
	rootCmd.AddCommand(newAppointmentTypesCmd(flags))
	rootCmd.AddCommand(newAppointmentsCmd(flags))
	rootCmd.AddCommand(newAutomationsCmd(flags))
	rootCmd.AddCommand(newAutomationsPeopleCmd(flags))
	rootCmd.AddCommand(newCallsCmd(flags))
	rootCmd.AddCommand(newCustomFieldsCmd(flags))
	rootCmd.AddCommand(newDealAttachmentsCmd(flags))
	rootCmd.AddCommand(newDealCustomFieldsCmd(flags))
	rootCmd.AddCommand(newDealsCmd(flags))
	rootCmd.AddCommand(newEmCampaignsCmd(flags))
	rootCmd.AddCommand(newEmEventsCmd(flags))
	...
	rootCmd.AddCommand(newPeopleRelationshipsCmd(flags))
	rootCmd.AddCommand(newPersonAttachmentsCmd(flags))
	rootCmd.AddCommand(newPipelinesCmd(flags))
	rootCmd.AddCommand(newPondsCmd(flags))
	...
	rootCmd.AddCommand(newTextMessageTemplatesCmd(flags))
	rootCmd.AddCommand(newTextMessagesCmd(flags))
	...
	// PATCH: Register hand-authored agent-native CRM workflows alongside the
	// generated endpoint wrappers without replacing agent-context introspection.
	rootCmd.AddCommand(newAgentCRMCmd(flags))
	rootCmd.AddCommand(newAPICmd(flags))
	rootCmd.AddCommand(newActionPlansPromotedCmd(flags))
	rootCmd.AddCommand(newIdentityPromotedCmd(flags))
	rootCmd.AddCommand(newMePromotedCmd(flags))
	rootCmd.AddCommand(newTeamInboxesPromotedCmd(flags))
	rootCmd.AddCommand(newThreadedRepliesPromotedCmd(flags))
	rootCmd.AddCommand(newTimeframesPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("follow-up-boss-pp-cli %s\n", version)
		},
	}
}
