...
but do not stop the import.`,
  ...
  shipsgo-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  shipsgo-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | shipsgo-pp-cli import <resource> --input -`,
